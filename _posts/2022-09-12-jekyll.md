...
In order to display proper code syntax highlighting in posts, I downloaded the Default Pygments theme. I added the css file to the `css` folder in my Jekyll project. I then needed to add the new file into `main.scss`:
```css
@import "pygments.css";
```
